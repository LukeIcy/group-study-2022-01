...
<body>
    ...
    <!-- nav bar -->
    <nav class="navbar navbar-expand-lg navbar-dark px-5" style="background-color: #647D5C;">
        <div class="container">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item px-2 pt-lg-1">
                        <button type="button" class="btn btn-light btn-sm px-3"
                            style="color: #647D5C;border-radius: 6px;font-size: 16px;background-color: #f3ede0;">註冊/登入</button>
                    </li>
                </ul>
            </div>
        </div>
