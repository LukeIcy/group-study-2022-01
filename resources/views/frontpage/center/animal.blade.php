    ...
    <section class="animal_information">
        <div class="container">
            <div class="next text-end mb-2">
                <a class="text-dark fw-bolder fs-6 text-decoration-none" href="{{ route('center.index') }}"><i
                        class="fas fa-caret-right"></i> 返回上一頁</a>
            </div>
            <div class="row mb-3">
                ...
                <div class="col">
                    <div class="apply d-flex flex-column align-items-center">
                        ...
                        <ul>
                            ...
                            @guest
                            <li>想瞭解{{ $animal->name }}的認養條件？ 歡迎註冊或登入。
                            </li>
                            @endguest
                        </ul>
                    </div>
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                <div class="condition d-flex flex-column align-items-center">
                                    <h2>認養條件</h2>
                                    <span>【須簽署認養協議書，內容請參見：<a href="https://reurl.cc/DdyQv6">https://reurl.cc/DdyQv6</a>】</span>
                                    ...
                                    <div class="requisition_write">
                                        ...
                                        <div class="mb-5">
                                            <label for="myself" class="form-label">自我介紹<span
                                                    class="text-danger mx-2">*</span></label>
                                            <textarea class="form-control mb-3" name="myself" id="myself" rows="3"
                                                required></textarea>
                                            <h5>附註：</h5>
